...
WAVELENGHTS_DIRBE = [1.25, 2.2, 3.5, 4.9, 12, 25, 60, 100, 140, 240] * u.micron
...
DIRBE = Emissivity(
    spectrum=WAVELENGHTS_DIRBE,
    components={
        ComponentLabel.CLOUD: (1.0, 1.0, 1.66, 0.997, 0.958, 1.00, 0.733, 0.647, 0.677, 0.519),
        ComponentLabel.BAND1: (1.0, 1.0, 1.66, 0.359, 1.01, 1.00, 1.25, 1.52, 1.13, 1.40),
        ComponentLabel.BAND2: (1.0, 1.0, 1.66, 0.359, 1.01, 1.00, 1.25, 1.52, 1.13, 1.40),
        ComponentLabel.BAND3: (1.0, 1.0, 1.66, 0.359, 1.01, 1.00, 1.25, 1.52, 1.13, 1.40),
        ComponentLabel.RING: (1.0, 1.0, 1.66, 1.06, 1.06, 1.0, 0.873, 1.1, 1.5, 0.858),
        ComponentLabel.FEATURE: (1.0, 1.0, 1.66, 1.06, 1.06, 1.0, 0.873, 1.1, 1.5, 0.858),
    }
)