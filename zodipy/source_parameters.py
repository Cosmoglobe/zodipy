...
EMISSIVITY_DIRBE: Dict[Union[str, Label], Any] = {
    Label.CLOUD: (1.0, 1.0, 1.66, 0.997, 0.958, 1.0, 0.733, 0.647, 0.677, 0.519),
    Label.BAND1: (1.0, 1.0, 1.66, 0.359, 1.01, 1.0, 1.25, 1.52, 1.13, 1.40),
    Label.BAND2: (1.0, 1.0, 1.66, 0.359, 1.01, 1.0, 1.25, 1.52, 1.13, 1.40),
    Label.BAND3: (1.0, 1.0, 1.66, 0.359, 1.01, 1.0, 1.25, 1.52, 1.13, 1.40),
    Label.RING: (1.0, 1.0, 1.66, 1.06, 1.06, 1.0, 0.873, 1.1, 1.15, 0.858),
    Label.FEATURE: (1.0, 1.0, 1.66, 1.06, 1.06, 1.0, 0.873, 1.1, 1.15, 0.858),
