...
from zodipy._source_funcs import blackbody_emission_nu, interplanetary_temperature
...
def test_blackbody_emission_value():
    ...
    emission = blackbody_emission_nu(T=TEMPERATURE, freq=FREQUENCY)
...
def test_blackbody_emission_value_array():
    ...
    emission = blackbody_emission_nu(T=TEMPERATURE_ARRAY, freq=FREQUENCY)
